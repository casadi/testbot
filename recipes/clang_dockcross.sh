...
if [ -z "$SETUP" ]; then
  ...
  build_env "sudo yum install -y libxml2-devel subversion;cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=\"$mypwd/install\" ../llvm;make clang-tblgen install -j2"
